...
app.set('port', (process.env.PORT || 7396))
...
*/
app.get('/niranjan', function(request, response) {
...
app.get('/redirect', function(req, res) {
    ...
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/niranjan");
      })
